  ...
  <div class="bg-slate-950 min-h-screen flex items-center justify-center p-4">
    <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 w-full max-w-[400px] shadow-xl flex flex-col gap-8"
      ...
      <div class="text-center flex flex-col items-center gap-2">
        ...
        <h1 class="text-2xl font-bold text-slate-100 m-0">AI Pilot</h1>
        <p class="text-sm text-slate-500 m-0 leading-relaxed">Управление WordPress-сайтами через ИИ</p>
      </div>
      ...
      <form class="flex flex-col gap-5" @submit.prevent="handleLogin">
        ...
        <!-- Error -->
        <div v-if="error"
          class="bg-red-500/10 border border-red-500/30 text-red-300 text-sm rounded-xl px-4 py-2.5 flex items-center gap-2">
      ...
      <!-- Footer -->
      <p class="text-center text-xs text-slate-600 leading-relaxed m-0">
